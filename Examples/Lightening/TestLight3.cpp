...
void TestLight3::Init()
{
	...
	//load shader
	_shader = _shaderManager->LoadFromFile("model", "Assets/Shaders/lightening2_diffuse", "Assets/Shaders/lightening3_cube", TextureNormal);
...
void TestLight3::Enter()
{

}

void TestLight3::CleanUp()
{
	delete _cube;
	delete _lamp;
...
void TestLight3::Pause()
{

}

void TestLight3::Resume()
{

}

void TestLight3::GamePause()
{

}

void TestLight3::GameResume()
{

}

void TestLight3::HandleEvents(GameManager* manager)
{
...
void TestLight3::Update(GameManager* manager)
{
	_dt = _timer->GetDelta();
	_rotation += _dt;
...
void TestLight3::Draw(GameManager* manager)
{
	//start frame
