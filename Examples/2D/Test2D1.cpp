...
void Test2D1::GamePause()
{

}

void Test2D1::GameResume()
{

}

void Test2D1::HandleEvents(GameManager* manager)
{
...
void Test2D1::Update(GameManager* manager)
{

}

void Test2D1::Draw(GameManager* manager)
{
	//start frame
