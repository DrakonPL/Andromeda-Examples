...
void Test6::GamePause()
{

}

void Test6::GameResume()
{

}

void Test6::HandleEvents(GameManager* manager)
{
...
void Test6::Update(GameManager* manager)
{

}

void Test6::Draw(GameManager* manager)
{
	//start frame
