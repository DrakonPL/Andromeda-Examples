...
void BulletBallTest::Init()
{
	...
	_soccerModel->ConvertToBinary("Assets/Models/Obj/soccer_ball/soccer_ball2.obj","Assets/Models/Obj/soccer_ball/soccer_ball2.objb");
	_soccerModel->LoadBinary("Assets/Models/Obj/soccer_ball/soccer_ball2.objb");
...
void BulletBallTest::InitModels()
{
	//create floor model
	{
...
void BulletBallTest::InitPhysic()
{
	...
	//Create the box object
	{
		...
		physBallShape = new btSphereShape(0.5f);// btBoxShape(btVector3(0.5, 0.5, 0.5));
...
glm::mat4 BulletBallTest::btScalar2glmMat4(btScalar* matrix)
{
	return glm::mat4(
...
void BulletBallTest::Pause()
{

}

void BulletBallTest::Resume()
{

}

void BulletBallTest::GamePause()
{

}

void BulletBallTest::GameResume()
{

}

void BulletBallTest::HandleEvents(GameManager* manager)
{
	...
	if (_keyboard != 0)
	{
		...
		if (_keyboard->KeyDown(Key::W))
			desiredVelocity.x = 1.0f * maxSpeed;
...
void BulletBallTest::Update(GameManager* manager)
{
	_dt = _timer->GetDelta();

	float maxSpeedChange = maxAcceleration * _dt;
//	physBallBody->setLinearVelocity(btVector3(desiredVelocity.x, desiredVelocity.y, desiredVelocity.z));
	velocity = glm::vec3(physBallBody->getLinearVelocity().getX(), physBallBody->getLinearVelocity().getY(), physBallBody->getLinearVelocity().getZ());
	...
	physBallBody->setLinearVelocity(btVector3(velocity.x, velocity.y, velocity.z));
...
void BulletBallTest::Draw(GameManager* manager)
{
	//start frame
