...
void BulletCharacterTest::InitModels()
{
	//create floor model
	{
...
void BulletCharacterTest::InitPhysic()
{
	...
	controller = new DynamicCharacterController(physBallBody, physBallShape);
}

glm::mat4 BulletCharacterTest::btScalar2glmMat4(btScalar* matrix)
{
	return glm::mat4(
...
void BulletCharacterTest::CleanUp()
{
	delete _soccerModel;
	delete _floorModel;
...
void BulletCharacterTest::Pause()
{

}

void BulletCharacterTest::Resume()
{

}

void BulletCharacterTest::GamePause()
{

}

void BulletCharacterTest::GameResume()
{

}

void BulletCharacterTest::HandleEvents(GameManager* manager)
{
...
void BulletCharacterTest::Update(GameManager* manager)
{
	_dt = _timer->GetDelta();
...
void BulletCharacterTest::Draw(GameManager* manager)
{
	//start frame
