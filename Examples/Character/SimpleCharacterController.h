#ifndef SimpleCharacterController_H
#define SimpleCharacterController_H
 ...
 */
class SimpleCharacterController : public btActionInterface
{
public:
	/**
	 ...
	 */
	SimpleCharacterController(btRigidBody *body, const btCapsuleShape *shape);
	virtual ~SimpleCharacterController() = default;
